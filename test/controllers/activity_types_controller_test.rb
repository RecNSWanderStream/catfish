...
class ActivityTypesControllerTest < ActionController::TestCase
  ...
  test "should create activity_type" do
    assert_difference('ActivityType.count') do
      post :create, activity_type: { activity_category_id: @activity_type.activity_category_id, description: @activity_type.description, name: @activity_type.name }
    end
  ...
  test "should update activity_type" do
    patch :update, id: @activity_type, activity_type: { activity_category_id: @activity_type.activity_category_id, description: @activity_type.description, name: @activity_type.name }
    assert_redirected_to activity_type_path(assigns(:activity_type))
  end
